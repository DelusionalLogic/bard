...
badd +39 unit.h
badd +29 unit.c
badd +21 configparser.h
badd +3 Makefile.in
badd +2 Makefile.am
badd +51 configparser.c
badd +2 ../build/src/conf/10-test.sh
argglobal
silent! argdel *
argadd main.c
edit main.c
...
exe '1resize ' . ((&lines * 2 + 32) / 65)
exe '2resize ' . ((&lines * 60 + 32) / 65)
exe 'vert 2resize ' . ((&columns * 126 + 114) / 228)
exe '3resize ' . ((&lines * 60 + 32) / 65)
exe 'vert 3resize ' . ((&columns * 101 + 114) / 228)
argglobal
enew
setlocal keymap=
setlocal noarabic
...
265
normal! zo
let s:l = 215 - ((41 * winheight(0) + 30) / 60)
